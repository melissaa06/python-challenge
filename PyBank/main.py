...
print("Total sum of profit/losses:", total_profit_loss)
print("Average profit/loss changes:", average_profit_losses_change)
print("Greatest profit increase:", max_profit_increase_date,max_profit_increase)
print("Greatest profit decrease:", min_profit_decrease_date, min_profit_decrease)